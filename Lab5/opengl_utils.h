...
namespace Lab5
{
	...
	public:
		...
		void createShaders()
		{
			...
			CubeMapID = LoadShaders("../Lab5/shaders/cubeMap.vs", "../Lab5/shaders/cubeMap.fs");
			ShaderWithTextureID = LoadShaders("../Lab5/shaders/BlinnPhongWithTexture.vs", "../Lab5/shaders/BlinnPhongWithTexture.fs"); 			
		}
